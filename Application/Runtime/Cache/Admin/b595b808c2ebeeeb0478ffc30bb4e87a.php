...
<head>
    ...
    <script>
	var URL = '/69ys/index.php/Admin/Index';
	var SELF = '/69ys/';
	var ROOT_PATH = '/69ys';
...
<body scroll="no">
<div id="header">
	<div class="logo"><a href="/69ys/index.php" title="<?php echo L('website_manage');?>"></a></div>
    <div class="fr">
...
<script type="text/javascript" src="/69ys/Public/static/admin/js/jquery/jquery.js"></script></script>
<script type="text/javascript" src="/69ys/Public/static/admin/js/pinphp.js"></script></script>
<script>
//初始化弹窗
(function (d) {
...
<script src="/69ys/Public/static/admin/js/index.js"></script>
</body>
</html>