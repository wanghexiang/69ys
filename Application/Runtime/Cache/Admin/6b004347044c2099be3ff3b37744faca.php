...
<div class="dialog_content">
	...
	<table width="100%" class="table_form">
		<tr> 
			...
			<td>
				<select class="J_cate_select mr10" data-pid="0" data-uri="<?php echo U('articlecate/ajax_getchilds');?>" data-selected="<?php echo ($b_name); ?>"></select>
				<input type="hidden" name="parent_id" id="J_cate_id" />
			</td>
		</tr>
		<tr>
			<th><?php echo L('article_cate_name');?> :</th>
			<td><input type="text" name="b_name" id="b_name" class="input-text" size="30"></td>
		</tr>
		<tr>
...
<script src="/diguniu/Public/static/admin/js/fileuploader.js"></script>
<script>
$(function(){
	$.formValidator.initConfig({formid:"info_form",autotip:true});
	$("#b_name").formValidator({onshow:lang.please_input+lang.article_cate_name,onfocus:lang.please_input+lang.article_cate_name}).inputValidator({min:1,onerror:lang.please_input+lang.article_cate_name});
