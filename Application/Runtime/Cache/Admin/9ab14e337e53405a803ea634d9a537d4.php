...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/diguniu/Public/static/admin/css/admin/style.css" />
	<title><?php echo L('website_manage');?></title>
	<script>
	var URL = '/diguniu/index.php/Admin/Articlecate';
	var SELF = '/diguniu/index.php?m=Admin&c=articlecate&a=index&menuid=156';
	var ROOT_PATH = '/diguniu';
	var APP	 =	 '/diguniu/index.php';
	//语言项目
	var lang = new Object();
...
<script type="text/javascript" src="/diguniu/Public/static/admin/js/jquery/jquery.js"></script>
<script type="text/javascript" src="/diguniu/Public/static/admin/js/jquery/plugins/jquery.tools.min.js"></script>
<script type="text/javascript" src="/diguniu/Public/static/admin/js/jquery/plugins/formvalidator.js"></script>
<script type="text/javascript" src="/diguniu/Public/static/admin/js/pinphp.js"></script>
<script type="text/javascript" src="/diguniu/Public/static/admin/js/admin.js"></script>
<script>
//初始化弹窗
(function (d) {
...
<?php if(isset($list_table)): ?><script type="text/javascript" src="/diguniu/Public/static/admin/js/jquery/plugins/listTable.js"></script>
<script>
$(function(){
